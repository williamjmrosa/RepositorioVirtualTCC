    ...
    switch($OP){
        ...
        case 2:
            ...
            if(!isset($_POST['email'])){
                ...
                $erros[] = 'Campo E-mail em branco!';
            }elseif(!Validacao::validarEmail($_POST['email'])){
                $erros[] = 'E-mail inválido!';
            }else{
                $email = filter_var($_POST['email'],FILTER_SANITIZE_EMAIL);
                if(!Validacao::validarTamanho($email,60)){
            ...
            if(!isset($_POST['cpf'])) {
                ...
                $erros[] = 'Campo CPF em branco!';
            }elseif(!Validacao::validarCPF($_POST['cpf'])){
                $erros[] = 'CPF inválido!';
            }else{
                $cpf = filter_var($_POST['cpf'], FILTER_SANITIZE_SPECIAL_CHARS);
            }
            ...
            if(!isset($_POST['telefone'])) {
                ...
                $erros[] = 'Campo Telefone em branco!';
            }elseif(!Validacao::validarContato($_POST['telefone'])){
                $erros[] = 'Contato inválido!';
            }else{
            ...
            if(!isset($_POST['numero'])){
                $erros[] = 'Campo Número não existe!';
            }elseif($_POST['numero'] == ""){
        ...
        case 3:
            ...
            if(isset($_GET['id'])){
                ...
                $professores = $professorDAO->alterarStatusProfessor($matricula);

                if($professores){
                    $_SESSION['msg'] = "Status Professor alterado com sucesso.";
                }else{
                    $erros[] = "Erro ao alterar o Status do Professor.";
                    $_SESSION['erros'] = serialize($erros);
                }
            }else{
                $erros[] = "Acesso negado.";
