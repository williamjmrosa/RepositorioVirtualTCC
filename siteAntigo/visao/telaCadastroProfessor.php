...
if(isset($_SESSION['usuario'])) {
  ...
  if($tipo != 'Adm' && $tipo != 'Bibliotecario'){
    $erros[] = "Efetue o login como Adm ou Bibliotecário para acessar tela de Cadastro Professor!";
...
<body class="container-fluid m-0 p-0 fundo-secundario">
  ...
  <div class="corpo">
    <div class="cadastro w-auto">
      <form class="row g-3" method="POST" action="../controle/professor-controle.php?OP=1">
    ...
    <div class="row g-3 m-4 cadastro w-auto">
      ...
      <table class="table table-striped">
        ...
        <tbody id="alterar">
          <!-- Inicio da Lista de Professores para Alterar/Excluir -->
          <!-- Carregamento da Lista de Professores via JS -->
          <!-- Fim da Lista de Professores para Alterar/Excluir -->
        </tbody>
      </table>
    </div>
  </div>
  ...
  <script src="../js/js-cadastro-professor.js"></script>
